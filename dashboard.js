...
let employeeData = [
  {
    ...
    name: "Rushabh",
    lastName: "Anam",
    profileImage: "./Media/WarRankingCard/profile_picture_3.png",
...

  {
    ...
    name: "Divya",
    lastName: "Sheth",
    profileImage: "./Media/WarRankingCard/profile_picture_2.png",
    designation: "Sr. Frontend Developer",
    department: "Frontend",
    checkInTime: "09:15",
    checkOutTime: "-- : --",
...

  {
    ...
    name: "Divyam",
    lastName: "Shah",
    profileImage: "./Media/WarRankingCard/profile_picture_1.png",
...
function populateTable() {
  filteredData.forEach(function (row, i) {
    ...
    <td class="tableWarScore d-none d-lg-table-cell">${row.warScore}</td>
  </tr>`;
